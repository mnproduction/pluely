...
export const Providers = ({
  ...
  const removeApiKey = () => {
    ...
    onSetSelectedSttProvider({
      ...selectedSttProvider,
      variables: { ...selectedSttProvider.variables, [apiKeyVar.key]: "" },
    });
  };
          ...
          options={allSttProviders?.map((provider) => {
            ...
            return {
              label: provider?.isCustom
                ...
                : provider?.id === "xai-stt" ? "xAI Speech to Text" : provider?.id || "Custom Provider",
        ...
        <div className="space-y-2">
          ...
          <div className="space-y-2">
            <div className="flex gap-2">
              <SecretInput
                aria-label="Speech provider API key"
                placeholder="**********"
              ...
              {!isApiKeyEmpty() && (
                <Button
                  ...
                  aria-label="Remove speech provider API key"
                >
