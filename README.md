...
Debug builds created with `npm run tauri dev` intentionally keep the Assistant and Dashboard visible to screen-capture tools and in Mira's own screenshots. Release builds retain capture exclusion and the screenshot-time window hiding behavior.
